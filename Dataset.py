...
class Dataset(object):
    ...
    def __init__(
        ...
        col_userVec=DEFAULT_USERVEC_COL,
        col_itemVec=DEFAULT_ITEMVEC_COL,
        binary=True,
        seed=None,
    ):
        """Constructor
        ...
        self.col_userVec = col_userVec
        self.col_itemVec = col_itemVec
    ...
    def _data_processing(self, train, test, binary):
        ...
        if self.user_idx is None:
            # Map user id
            user_idx = df[[self.col_user]].drop_duplicates(self.col_user).reindex()
        ...
        if self.item_idx is None:
            # Map item id
            item_idx = df[[self.col_item]].drop_duplicates(self.col_item).reindex()
    ...
    def _init_test_data(self):
        ...
        if self.test is not None:
            ...
            #print(test_interact_status[self.col_item + "_interacted_test"])
            #print(test_interact_status["userID"])
            #print(self.interact_status["userID"])
            test_interact_status[
